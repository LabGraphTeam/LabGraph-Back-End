...
public class AnalyticsHelperMocks {
    ...
    public static List<AnalyticsDTO> createComprehensiveRecordList() {
        ...
        records.add(new AnalyticsDTO(1L, baseDate, "0774693", "608384",
    ...
    public static List<AnalyticsDTO> createHematologyRecordList() {
        ...
        records.add(new AnalyticsDTO(2L, baseDate, "0774693", "608384",
                                        "RBC", "NORMAL", 5.2, 5.0, 0.2, "10^6/µL", "Average", "Approved"));
        records.add(new AnalyticsDTO(3L, baseDate, "0774693", "608384",
                                        "HGB", "NORMAL", 14.5, 14.0, 0.5, "g/dL", "Average", "Approved"));
        records.add(new AnalyticsDTO(4L, baseDate, "0774693", "608384",
                                        "HCT", "NORMAL", 42.0, 41.0, 1.0, "%", "Average", "Approved"));

        // RBC Indices
        records.add(new AnalyticsDTO(5L, baseDate, "0774693", "608384",
                                        "MCV", "NORMAL", 88.0, 87.0, 1.0, "fL", "Average", "Approved"));
        records.add(new AnalyticsDTO(6L, baseDate, "0774693", "608384",
                                        "MCH", "LOW", 27.0, 29.0, 1.0, "pg", "-2s", "Failed"));
        records.add(new AnalyticsDTO(7L, baseDate, "0774693", "608384",
                                        "MCHC", "HIGH", 36.0, 34.0, 1.0, "g/dL", "+2s", "Failed"));

        // Differential Counts
        records.add(new AnalyticsDTO(8L, baseDate, "0774693", "608384",
                                        "NEU#", "NORMAL", 4.5, 4.3, 0.2, "10^3/µL", "Average", "Approved"));
        records.add(new AnalyticsDTO(9L, baseDate, "0774693", "608384",
